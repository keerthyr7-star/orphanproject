  ...
  return (
    <>
        ...
        <main>
            ...
            <div className="shelterMain">
                <h1>Nearby Shelters</h1>
                <button className='shelterBtn'>Add Shelters</button>
            </div>

        <div className="mainSheltercontainer">
            ...
            <div className="shelterContainer">
             ...
             <div className="shelterContainer">
                 <i className="fa-solid fa-bed blue"></i>
             ...
             <div className="shelterContainer">
                 <i class="fa-solid fa-location-crosshairs blueviolet"></i>
        ...
        <div className="findings">
            ...
            <div className="shelterFindings">
                <h1>Nearby Shelters </h1>
                <p>Find shelters near your location</p>
            </div>
        </div>
            ...
            <div className="filterShel">
                ...
                <input type="text" placeholder="Search shelters..." />
            </div>
            </div>

        </div>

        <div className="Allshelters">

            <div className="shelterHomes">

                <div className="homeicp">
                    <i class="fa-solid fa-house"></i>
                    <p>12 beds open</p>
                </div>

                <p className='shelterp'>Asha Nilayam Shelter</p>

                <div className="homeicp2">
                    <i class="fa-solid fa-location-dot"></i>
                    <p>1.2km T.Nagar</p>
                </div>
...
<div className="shelterHomes">
            ...
            <div className="shelterHomes">
                ...
                <div className="shelterHomeslast">

                <div className="homeicplast disabledCard">
                    <i class="fa-solid fa-house"></i>
                    <p>full</p>
                </div>
